...
$(document).ready(function() {
    $("body").on("click", "[data-sa-action]", function(e) {
        ...
        case "aside-open":
            ...
            $(a).addClass("toggled"),
            $(".content, .header").append('<div class="sa-backdrop" data-sa-action="aside-close" data-sa-target=' + a + " />");
            break;
        case "aside-close":
            a = t.data("sa-target"),
            $("body").removeClass("aside-toggled"),
            $('[data-sa-action="aside-open"], ' + a).removeClass("toggled"),
...
$(document).ready(function() {
    ...
    setInterval(function() {
        ...
        $(".time__ampm").html(ampm); // Add this line to display AM/PM
    }, 1e3);
}
...
$(document).ready(function() {
    $(".color-picker")[0] && ($(".color-picker__value").colorpicker(),
...
$(document).ready(function() {
    ...
    $(".notes__body")[0] && $(".notes__body").each(function(e, t) {
        a = $(this).prev().is(".notes__title") ? 4 : 6,
        $clamp(t, {
            clamp: a
        })
    })
...
$(document).ready(function() {
    if ($("#data-table")[0]) {
        ...
        $("body").on("click", "[data-table-action]", function(e) {
            ...
            if ("excel" === t && $("#data-table_wrapper").find(".buttons-excel").click(),
            "csv" === t && $("#data-table_wrapper").find(".buttons-csv").click(),
            "print" === t && $("#data-table_wrapper").find(".buttons-print").click(),
            "fullscreen" === t) {
...
$(document).ready(function() {
    if ($("#widget-calendar-body")[0]) {
        ...
        $(".widget-calendar__year").html(e.getFullYear()),
        $(".widget-calendar__day").html(["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"][e.getDay()] + ", " + ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"][e.getMonth()].substring(0, 3) + " " + e.getDay())
    }
    if ($("#calendar")[0]) {
        t = document.getElementById("calendar");
        var a, o, i, l = document.getElementById("calendar-title"), n = (e = new Date).getMonth(), r = e.getFullYear(), s = [{
            id: 1,
        ...
        (i = new FullCalendar.Calendar(t,{
            ...
            datesRender: function() {
                var e = i.getDate();
                t.setAttribute("data-calendar-month", e.getMonth() + 1),
                l.innerText = i.view.title
            },
            dateClick: function(e) {
                o = e.dateStr;
                var t = $("#event-new");
                t.modal("show"),
                t.find(".event-new__title").val("").removeClass("is-invalid")
            },
            eventClick: function(e) {
                ...
                t.modal("show"),
                t.find(".event-new__title").val("").removeClass("is-invalid"),
                t.find(".event-edit__title").val(e.event.title)
            }
        })).render(),
        ...
        $(".event-edit__update").on("click", function() {
            ...
            0 == t.length ? e.addClass("is-invalid") : (i.getEventById(a).setProp("title", t),
            $("#event-edit").modal("hide"))
        }),
        $(".event-edit__delete").on("click", function() {
            i.getEventById(a).remove(),
            $("#event-edit").modal("hide")
        })
    }
}),
...
$(document).ready(function() {
    ...
    if ($(".input-slider")[0])
        for (var o = document.getElementsByClassName("input-slider"), i = 0; i < o.length; i++)
            noUiSlider.create(o[i], {
                start: [20],
                connect: "lower",
                range: {
                    min: 0,
